              ...
              <View style={styles.modalText}>
                ...
                <View style={styles.table}>
                  <View style={styles.column}>
                    <TouchableOpacity
                      onPress={() =>
                        Linking.openURL(this.state.modalItem.pdf)
                      }>
                  ...
                  {this.state.modalItem.kardecpedia ?
                    <View style={styles.column}>
                      <TouchableOpacity
                        onPress={() =>
                          Linking.openURL(this.state.modalItem.kardecpedia)
                        }>
                        <Image style={styles.image}
